...
public interface ImunisasiRepository extends JpaRepository<Imunisasi, Integer>{
	...
	@Query(value = "select idimunisasi, idbalita, namaimunisasi ,tanggalimunisasi ,catatanimunisasi  from imunisasi i where tanggalimunisasiberikutnya = current_date + interval '1 day' order by tanggalimunisasiberikutnya asc ", nativeQuery = true)
